...
title = pygame.display.set_caption("Tanker")
path = pygame.image.load("Untitled-1.png")
icon = pygame.display.set_icon(path)

# PLAYER SPITE
skin = pygame.image.load("Untitled-1.png")
playerX = 370
playerY = 510
speed = 0
# ENEMY SPITE
...
for i in range(number_of_enemy):
    enemy_skin.append(pygame.image.load("jet-fighter.png"))
...
while running:
    ...
    # parallex background
    colour = screen.fill((255, 255, 255))
